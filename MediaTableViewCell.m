...
#pragma mark - constraints iPhone iPad
...
- (void) createPadConstraints {
    ...
    // on iPad, fix image size at 320 pt and center it on the screen
...
//        self.imageHeightConstraint.constant = self.mediaItem.image.size.height / self.mediaItem.image.size.width * CGRectGetWidth(self.contentView.bounds);
        ...
        self.imageHeightConstraint.constant = 0; // OK to set to non-zero for smoother scrolling
    }
